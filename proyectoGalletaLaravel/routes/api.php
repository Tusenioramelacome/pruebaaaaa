...
Route::get('/mensaje', function (Request $request) {
    ...
    $indiceAleatorio = array_rand($mensajes); // Obtener un índice aleatorio
    $mensajeFortuna = $mensajes[$indiceAleatorio]; // Obtener el mensaje aleatorio

    return response()->json(['mensaje' => $mensajeFortuna]);
});